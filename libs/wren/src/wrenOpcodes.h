...
//
//Note that the order of instructions here affects the order of the dispatch table in the VM's 
//interpreter loop. That in turn affects caching which affects overall performance. Take care 
//to run benchmarks if you change the order here.
...
// Import a module whose name is the string stored at [arg] in the constant table.
//
...
// variable to import is at [arg] in the constant table. Pushes the loaded variable's value.
