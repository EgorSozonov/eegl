...
hi QuickFixLine fg=#ffffff bg=#2e8b57 deco=NONE cterm=NONE
hi ColorColumn fg=NONE bg=#cd0000 deco=NONE cterm=NONE
hi CursorColumn fg=NONE bg=#3a3a3a deco=NONE cterm=NONE
hi CursorLine fg=NONE bg=#3a3a3a deco=NONE cterm=NONE
hi CursorLineNr fg=#ffff00 bg=NONE deco=bold cterm=bold
hi Folded fg=#00ffff bg=#666666 deco=NONE cterm=NONE
hi Conceal fg=#666666 bg=NONE deco=NONE cterm=NONE
hi Cursor fg=#000000 bg=#00ffff deco=NONE cterm=NONE
hi Directory fg=#00ffff bg=#000000 deco=NONE cterm=NONE
hi EndOfBuffer fg=#0000ff bg=#000000 deco=bold cterm=NONE
hi ErrorMsg fg=#ffffff bg=#cd0000 deco=NONE cterm=NONE
hi FoldColumn fg=#00ffff bg=NONE deco=NONE cterm=NONE
hi IncSearch fg=NONE bg=#000000 deco=reverse cterm=reverse
...
hi NonText fg=#0000ff bg=NONE deco=bold cterm=bold
hi Pmenu fg=#ffffff bg=#444444 deco=NONE cterm=NONE
hi PmenuSbar fg=NONE bg=#bebebe deco=NONE cterm=NONE
hi PmenuSel fg=#000000 bg=#00cdcd deco=NONE cterm=NONE
hi PmenuThumb fg=NONE bg=#ffffff deco=NONE cterm=NONE
hi PmenuMatch fg=#ff00ff bg=#444444 deco=bold cterm=bold
hi PmenuMatchSel fg=#ff00ff bg=#00cdcd deco=bold cterm=bold
hi Question fg=#00ff00 bg=NONE deco=bold cterm=bold
hi Search fg=#000000 bg=#ffff00 deco=NONE cterm=NONE
...
hi StatusLine fg=#000000 bg=#00ffff deco=bold cterm=bold
hi StatusLineNC fg=#000000 bg=#00cdcd deco=NONE cterm=NONE
hi TabLine fg=#000000 bg=#008b8b deco=NONE cterm=NONE
hi TabLineFill fg=NONE bg=#000000 deco=reverse cterm=reverse
hi TabLineSel fg=#00ffff bg=#000000 deco=bold cterm=bold
hi Terminal fg=#00ffff bg=#000000 deco=NONE cterm=NONE
hi Title fg=#ff00ff bg=NONE deco=bold cterm=bold
hi VertSplit fg=#000000 bg=#00cdcd deco=NONE cterm=NONE
hi Visual fg=#000000 bg=#a9a9a9 deco=NONE cterm=NONE
...
hi Error fg=#ffffff bg=#ff0000 deco=NONE cterm=NONE
hi Function fg=#ffffff bg=NONE deco=NONE cterm=NONE
hi Identifier fg=#40ffff bg=NONE deco=NONE cterm=NONE
hi Ignore fg=#000000 bg=#000000 deco=NONE cterm=NONE
hi Operator fg=#ff0000 bg=NONE deco=NONE cterm=NONE
hi PreProc fg=#ff80ff bg=NONE deco=NONE cterm=NONE
hi Repeat fg=#ffffff bg=NONE deco=NONE cterm=NONE
hi Special fg=#ff0000 bg=NONE deco=NONE cterm=NONE
hi Statement fg=#aa4444 bg=NONE deco=bold cterm=bold
