...
int searchit(Portal *port, Book *book, Pos *pos, Pos *end_pos, Unt dir, Text pat, long count, Unt options, int pat_use, SearchitArg *extra_arg);
void set_search_direction(int cdir);
int do_search(Operator *oap, int dirc, int search_delim, Text pat, long count, int options, SearchitArg *sia);
