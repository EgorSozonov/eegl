...
Boole searchPrepareHiliteLine(Portal *po, LineNr lnum, ColNr mincol, CS *line, Match *search_hl, Short *searchHiId);
Short update_search_hl(Portal *po, LineNr lnum, ColNr col, CS *line, Match *search_hl, int didLineDecorations, int lcs_eol_one, Boole *onLastCol);
int get_prevcol_hl_flag(Portal *po, Match *search_hl, long curcol);
void get_search_match_hl(Portal *po, Match *search_hl, long col, Short *charHiId);
