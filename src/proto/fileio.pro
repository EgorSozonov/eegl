...
CS home_replace_save(Book *book, CS src);
CS homeReplaceA(Book *book, CS src, Arena *a);
...
void filemess(Book *book, Byte *name, Byte *s, int attr);
...
void shorten_buf_fname(Book *book, Byte *dirname, int force);
