...
void normalAction(Operator *oper, int toplevel);
...
void didChangePortalSettingBuf(Book *buf);
...
void changed_line_display_buf(Book *buf);
...
int do_map(int maptype, Byte *arg, int mode, int abbrev);
...
int expandMappings(Byte *pat, RegMatch *regmatch, ExpandMatch *matches);
