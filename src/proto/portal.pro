...
void portEqualizeHeight(Portal *next_curPor, int current, Byte dir);
...
Portal *portRemoveFrame(Portal *port, Byte *dirp, Tab *t, Frame **unflat_altfr);
...
Portal *getPortAndTab(int id, Tab **result);
Portal *portFindByNr(Var *vp, Tab *t);
Portal *portFindByNrOrId(Var *vp);
Portal *find_tabwin(Var *needle, Var *tvp, Tab **ptp);
...
int find_word_under_cursor(int mouserow, int mousecol, int getword, Unt flags, Portal **winp, LineNr *lnump, CS *textp, int *colp, int *startcolp);
int get_beval_info(BalloonEval *beval, int getword, Portal **winp, LineNr *lnump, CS *textp, int *colp);
