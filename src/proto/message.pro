...
int msgOuttransDeco(Byte const *str, char flags);
...
int msg_outtrans_special(Byte *strstart, int from, int maxlen);
Byte *str2special_save(Byte *str, int replace_spaces, int replace_lt);
...
CS msgTruncDeco(CS s, int force, char flags);
CS msg_may_trunc(int force, CS s);
