...
int checkforcmd(Byte **pp, CS cmd, int len);
int checkforcmd_noparen(Byte **pp, CS cmd, int len);
...
CS findCommand(Invocation *invo, int *full, int (*lookup)(Byte *, Unt, int cmd));
...
CS evalVars(LineNr *lnump, CS *errorMsg, CS src, CS srcstart, Unt *usedlen, int *escaped, int empty_is_error);
