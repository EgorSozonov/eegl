...
int bookDo(Unt action, Unt start, Unt dir, int count, Unt flags);
CS do_bufdel(int command, CS arg, int addr_count, int start_bnr, int end_bnr, Boole forceit);
...
void fileinfo(Boole fullname, Boole shorthelp, Boole dont_truncate);
