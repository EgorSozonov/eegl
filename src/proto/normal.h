...
int find_ident_at_pos(Portal *po, LineNr lnum, ColNr startcol, CS *text, int *textcol, int find_type);
...
Boole getFolds(LineNr lnum, LineNr *firstp, LineNr *lastp);
Boole getFoldsPortal(Portal *po, LineNr lnum, LineNr *firstp, LineNr *lastp, int cache, FoldInfo *infop);
...
void opFoldRange(LineNr first, LineNr last, Boole opening, Boole recurse, Boole had_visual);
...
void foldMarkAdjust(Portal *po, LineNr line1, LineNr line2, long amount, long amount_after);
CS get_foldtext(Portal *po, LineNr lnum, LineNr lnume, FoldInfo *foldinfo, CS buffer);
