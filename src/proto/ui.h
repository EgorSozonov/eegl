...
void f_term_setsize(Arr(Var) argvars, Var*);
...
void f_term_list(Arr(Var), Var* returnVar);
void f_term_scrape(Arr(Var) argvars, Var* returnVar);
void f_term_sendkeys(Arr(Var) argvars, Var*);
void f_term_setapi(Arr(Var) argvars, Var*);
void f_term_setrestore(Arr(Var) argvars, Var*);
void f_term_setkill(Arr(Var) argvars, Var*);
void f_term_start(Arr(Var) argvars, Var* returnVar);
void f_term_wait(Arr(Var) argvars, Var*);
