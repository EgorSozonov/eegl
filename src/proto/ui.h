...
int uiRealWaitForChar(int fd, Long msec, int *interrupted);
...
int inchar_loop(CS buf, int maxlen, long wtime, int changeCnt, int (*wait_func)(long wtime, int *interrupted, Boole ignore_input), int (*resize_func)(int check_only));
int waitForChar(long msec, int *interrupted, Boole ignore_input);
