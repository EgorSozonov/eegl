...
CS get_fillchars_name(Expand *, int idx);
CS get_listchars_name(Expand *, int idx);
...
void after_updating_screen(int);
...
void f_screencol(Arr(Var), Var* returnVar);
void f_screenrow(Arr(Var), Var* returnVar);
