...
void *lallocZeroed(Unt size, int message);
void *lalloc(Unt size, int message);
...
CS make_percent_swname(Byte *dir, Byte *dir_end, Byte *name);
...
int mf_open_file(MemFile *mfp, Byte *fname);
