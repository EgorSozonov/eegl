...
void stuffReadbuff(Byte *s);
void stuffRedoReadbuff(Byte *s);
void stuffReadbuffLen(Byte *s, long len);
void stuffReadbuffSpec(Byte *s);
...
void restore_typeahead(TypeaheadSave *tp, int overwrite);
...
int utf_composinglike(Byte *p1, Byte *p2);
int utfc_ptr2char(Byte *p, int *pcc);
int utfc_ptr2char_len(Byte *p, int *pcc, int maxlen);
int utfc_char2bytes(int off, Byte *buf);
...
int utf_class(int c);
int utf_class_buf(int c, Book *buf);
...
int caseInsensitiveCompareNChars2(Byte *s1, Byte *s2, Unt n1, Unt n2);
int caseInsensitiveCompareNChars(Byte *s1, Byte *s2, Unt nn);
void show_utf8(void);
...
void mb_adjustpos(Book *buf, Pos *lp);
