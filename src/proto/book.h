...
int bookClose(Portal *port, Book *book, Unt action, int abort_if_last, int ignore_abort);
...
int bookRenderStatusLine(Portal *po, CS out, Unt outlen, CS fmt, Byte oname, int opt_scope, Unt fillchar, int maxwidth, StatusLineHilite **labels);
...
int bookWrite(Book *book, CS fname, CS sfname, LineNr start, LineNr end, Invocation *invo, Boole append, Boole forceit, Boole reset_changed, Boole filtering);
