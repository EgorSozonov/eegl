...
int applyAutocomms(AutoEvent event, CS fname, CS fname_io, Boole force, Book *book);
int auCommApplyWithInvo(AutoEvent event, CS fname, CS fname_io, Boole force, Book *book, Invocation *invo);
int applyAutocommsRetval(AutoEvent event, CS fname, CS fname_io, Boole force, Book *book, int *retval);
