...
void f_getwinpos(Arr(Var) argvars, Var* returnVar);
void f_getwinposx(Arr(Var), Var* returnVar);
void f_getwinposy(Arr(Var), OUT Var* returnVar);
void f_tabpagenr(Arr(Var) argvars, Var* returnVar);
void f_tabpagewinnr(Arr(Var) argvars, Var* returnVar);
...
void f_getcmdwintype(Arr(Var), Var* returnVar);
void f_winbufnr(Arr(Var) argvars, Var* returnVar);
void f_wincol(Arr(Var), Var* returnVar);
void f_winheight(Arr(Var) argvars, Var* returnVar);
void f_winlayout(Arr(Var) argvars, Var* returnVar);
void f_winline(Arr(Var), Var* returnVar);
void f_winnr(Arr(Var) argvars, Var* returnVar);
void f_winrestcmd(Arr(Var), Var* returnVar);
void f_winrestview(Arr(Var) argvars, Var*);
void f_winsaveview(Arr(Var), Var* returnVar);
...
void f_popup_close(Arr(Var) argvars, Var*);
void popup_hide(Portal* po);
void f_popup_hide(Arr(Var) argvars, Var*);
void popup_show(Portal* po);
void f_popup_show(Arr(Var) argvars, Var*);
void f_popup_settext(Arr(Var) argvars, Var*);
void f_popup_setbuf(Arr(Var) argvars, Var* returnVar);
...
void f_popup_move(Arr(Var) argvars, Var*);
void f_popup_setoptions(Arr(Var) argvars, Var*);
void f_popup_getpos(Arr(Var) argvars, Var* returnVar);
void f_popup_list(Arr(Var), OUT Var* returnVar);
...
void f_popup_findecho(Arr(Var), OUT Var* returnVar);
void f_popup_findinfo(Arr(Var), OUT Var* returnVar);
void f_popup_findpreview(Arr(Var), OUT Var* returnVar);
...
void post_balloon(BalloonEval*, CS mesg, List* list);
void general_beval_cb(BalloonEval* beval, int);
