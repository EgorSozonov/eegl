...
int list_assign_range(List *dest, List *src, long idx1_arg, long idx2, int empty_idx2, Byte *op, Text varname);
...
int list_join(ArrayList *gap, List *l, Byte *sep, int echo_style, int restore_copyID, int copyID);
...
Byte *tv_stringify(Var *varp, CS buf);
...
int eval_number(Byte **arg, Var *returnVar, int evaluate, int want_string);
...
CS string_slice(Byte *str, Long first, Long last, int exclusive);
void bagUnref(Bag *d);
...
int dict_wrong_func_name(Bag *b, Var *tv, Text name);
...
int eval_index_inner(Var *returnVar, int is_range, Var *var1, Var *var2, int exclusive, Byte *key, int keylen, int verbose);
...
void blob_remove(Var *argvars, Var *returnVar, Byte *arg_errmsg);
void blob_filter_map(Blob *blob_arg, FilterMap filtermap, Var *expr, Byte *arg_errmsg, Var *returnVar);
