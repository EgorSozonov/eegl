...
C(C_loadview,   "loadview",   c_loadview, FILE1|TRLBAR, ADDR_NONE),
...
C(C_mkspell,   "mkspell",   c_mkspell, BANG|NEEDARG|EXTRA|NOTRLCOM|TRLBAR|XFILE, ADDR_NONE),
...
C(C_spellgood,   "spellgood",   c_spell, BANG|RANGE|NEEDARG|EXTRA|TRLBAR, ADDR_OTHER),
C(C_spelldump,   "spelldump",   c_spelldump, BANG|TRLBAR, ADDR_NONE),
C(C_spellinfo,   "spellinfo",   c_spellinfo, TRLBAR, ADDR_NONE),
C(C_spellrepall,   "spellrepall", c_spellrepall, TRLBAR, ADDR_NONE),
C(C_spellrare,   "spellrare",   c_spell, BANG|RANGE|NEEDARG|EXTRA|TRLBAR, ADDR_OTHER),
C(C_spellundo,   "spellundo",   c_spell, BANG|RANGE|NEEDARG|EXTRA|TRLBAR, ADDR_OTHER),
C(C_spellwrong,   "spellwrong",   c_spell, BANG|RANGE|NEEDARG|EXTRA|TRLBAR, ADDR_OTHER),
