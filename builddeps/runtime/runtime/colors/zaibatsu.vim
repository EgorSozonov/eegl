...
hi Normal fg=#ffffff bg=#0e0024 deco=NONE cterm=NONE
hi EndOfBuffer fg=#afafff bg=#0e0024 deco=NONE cterm=NONE
hi NonText fg=#878092 bg=#0e0024 deco=NONE cterm=NONE
hi SpellBad fg=NONE bg=NONE guisp=#ff5faf deco=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
hi SpellCap fg=NONE bg=NONE guisp=#87ff00 deco=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
hi SpellLocal fg=NONE bg=NONE guisp=#ffffff deco=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
hi SpellRare fg=NONE bg=NONE guisp=#ffafff deco=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
hi StatusLine fg=#0e0024 bg=#ffffff deco=NONE cterm=NONE
hi StatusLineNC fg=#0e0024 bg=#afaab6 deco=NONE cterm=NONE
hi Pmenu fg=#0e0024 bg=#ffffff deco=NONE cterm=NONE
hi PmenuSbar fg=#d7d5db bg=#d7d5db deco=NONE cterm=NONE
hi PmenuSel fg=#0e0024 bg=#afafff deco=NONE cterm=NONE
hi PmenuThumb fg=#878092 bg=#878092 deco=NONE cterm=NONE
hi PmenuExtra fg=#878092 bg=#ffffff deco=NONE cterm=NONE
hi! link PmenuExtraSel PmenuSel
hi PmenuKind fg=#878092 bg=#ffffff deco=NONE cterm=NONE
hi! link PmenuKindSel PmenuSel
hi PmenuMatch fg=#d700ff bg=#ffffff deco=NONE cterm=NONE
hi PmenuMatchSel fg=#d700ff bg=#afafff deco=NONE cterm=NONE
hi ColorColumn fg=NONE bg=#510039 deco=NONE cterm=NONE
hi CursorLine fg=NONE bg=#362b49 deco=NONE cterm=NONE
hi CursorColumn fg=NONE bg=#362b49 deco=NONE cterm=NONE
hi WildMenu fg=#0e0024 bg=#afafff deco=NONE cterm=NONE
hi Conceal fg=NONE bg=NONE deco=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi Cursor fg=#0e0024 bg=#ffff5f deco=NONE cterm=NONE
hi CursorIM fg=#0e0024 bg=#ffff5f deco=NONE cterm=NONE
hi Error fg=#d70000 bg=#ffffff deco=reverse cterm=reverse
hi ErrorMsg fg=#ffffff bg=#d70000 deco=NONE cterm=NONE
hi FoldColumn fg=#00afff bg=NONE deco=NONE cterm=NONE
hi Folded fg=#ffaf00 bg=#0e0024 deco=reverse cterm=reverse
hi IncSearch fg=#ffaf00 bg=#0e0024 deco=reverse cterm=reverse
hi LineNr fg=#afafff bg=NONE deco=NONE cterm=NONE
hi MatchParen fg=NONE bg=NONE deco=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
hi ModeMsg fg=#0e0024 bg=#87ff00 deco=NONE cterm=NONE
hi MoreMsg fg=#87ffff bg=NONE deco=NONE cterm=NONE
hi Question fg=#87ff00 bg=NONE deco=NONE cterm=NONE
hi QuickFixLine fg=#ffafff bg=#0e0024 deco=reverse cterm=reverse
hi Search fg=#87ffff bg=#0e0024 deco=reverse cterm=reverse
hi SignColumn fg=#00afff bg=NONE deco=NONE cterm=NONE
hi SpecialKey fg=#878092 bg=NONE deco=NONE cterm=NONE
hi ToolbarButton fg=#ffffff bg=#5e556d deco=NONE cterm=NONE
hi ToolbarLine fg=NONE bg=NONE deco=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi VertSplit fg=#afafff bg=NONE deco=NONE cterm=NONE
hi Visual fg=#0e0024 bg=#5fd7ff deco=NONE cterm=NONE
hi VisualNOS fg=#0e0024 bg=#ffffff deco=NONE cterm=NONE
hi WarningMsg fg=#ffafff bg=NONE deco=NONE cterm=NONE
hi debugBreakpoint fg=#87ff00 bg=#5f00d7 deco=reverse cterm=reverse
hi debugPC fg=#87ffff bg=#5f00d7 deco=reverse cterm=reverse
hi Directory fg=#87ffff bg=NONE deco=NONE cterm=NONE
hi Title fg=NONE bg=NONE deco=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi Comment fg=#afafff bg=NONE deco=NONE cterm=NONE
hi Constant fg=#ffff5f bg=NONE deco=NONE cterm=NONE
hi Identifier fg=#87ffff bg=NONE deco=NONE cterm=NONE
hi Ignore fg=#878092 bg=NONE deco=NONE cterm=NONE
hi PreProc fg=#00afff bg=NONE deco=NONE cterm=NONE
hi Special fg=#87ff00 bg=NONE deco=NONE cterm=NONE
hi Statement fg=#ffafff bg=NONE deco=NONE cterm=NONE
hi Todo fg=NONE bg=NONE deco=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
hi Type fg=#ff5faf bg=NONE deco=NONE cterm=NONE
...
hi DiffAdd fg=#87ff00 bg=#362b49 deco=reverse cterm=reverse
hi DiffChange fg=#afafff bg=#362b49 deco=reverse cterm=reverse
hi DiffText fg=#d7d5db bg=#362b49 deco=reverse cterm=reverse
hi DiffDelete fg=#ff5faf bg=#362b49 deco=reverse cterm=reverse
