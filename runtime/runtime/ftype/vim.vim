...
//  command! -nargs=* VimFolda <args> fold
// else
//  command! -nargs=* VimFolda <args>
// endif
// if g:vimsyn_folding =~# 'f'
//  command! -nargs=* VimFoldf <args> fold
// else
//  command! -nargs=* VimFoldf <args>
// endif
// if g:vimsyn_folding =~# 'h'
//  command! -nargs=* VimFoldh <args> fold
// else
//  command! -nargs=* VimFoldh <args>
// endif
// if g:vimsyn_folding =~# 'l'
//  command! -nargs=* VimFoldl <args> fold
// else
//  command! -nargs=* VimFoldl <args>
// endif
// if g:vimsyn_folding =~# 'm'
//  command! -nargs=* VimFoldm <args> fold
// else
//  command! -nargs=* VimFoldm <args>
// endif
// if g:vimsyn_folding =~# 'p'
//  command! -nargs=* VimFoldp <args> fold
// else
//  command! -nargs=* VimFoldp <args>
// endif
// if g:vimsyn_folding =~# 'P'
//  command! -nargs=* VimFoldP <args> fold
// else
...
//  command! -nargs=* VimFoldr <args> fold
// else
//  command! -nargs=* VimFoldr <args>
// endif
// if g:vimsyn_folding =~# 't'
//  command! -nargs=* VimFoldt <args> fold
// else
//  command! -nargs=* VimFoldt <args>
// endif
//else
// command! -nargs=*	VimFolda	<args>
// command! -nargs=*	VimFoldf	<args>
...
syn match vimNumber	"\<\d\+\%(\.\d\+\%([eE][+-]\=\d\+\)\=\)\=" skipwhite 
         \nextgroup=vimGlobal,vimSubst,vimCommand,vimComment
syn match vimNumber	"-\d\+\%(\.\d\+\%([eE][+-]\=\d\+\)\=\)\="  skipwhite 
         \nextgroup=vimGlobal,vimSubst,vimCommand,vimComment
...
syn region	vimSynMatchRegion	contained keepend	matchgroup=vimGroupName start="\h\w*" 
         \matchgroup=vimSep end="|\|$" contains=@vimSynMtchGroup
