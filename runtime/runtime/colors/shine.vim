...
hi Folded fg=#00008b bg=#dadada deco=NONE cterm=NONE
hi CursorLine fg=NONE bg=#dadada deco=NONE cterm=NONE
hi CursorColumn fg=NONE bg=#dadada deco=NONE cterm=NONE
hi CursorLineNr fg=NONE bg=#dadada deco=NONE cterm=NONE
hi QuickFixLine fg=#000000 bg=#ff8c00 deco=NONE cterm=NONE
hi StatusLine fg=#ffffff bg=#000000 deco=bold cterm=bold
hi StatusLineNC fg=#ffffff bg=#a8a8a8 deco=NONE cterm=NONE
hi StatusLineTerm fg=#000000 bg=#90ee90 deco=bold cterm=bold
hi StatusLineTermNC fg=#dadada bg=#006400 deco=NONE cterm=NONE
hi VertSplit fg=#a8a8a8 bg=#a8a8a8 deco=NONE cterm=NONE
hi Pmenu fg=#000000 bg=#a8a8a8 deco=NONE cterm=NONE
hi PmenuSel fg=#000000 bg=#ffff60 deco=NONE cterm=NONE
hi PmenuSbar fg=#ffffff bg=#ffffff deco=NONE cterm=NONE
hi PmenuThumb fg=#767676 bg=#767676 deco=NONE cterm=NONE
hi PmenuMatch fg=#ff0000 bg=#a8a8a8 deco=NONE cterm=NONE
hi PmenuMatchSel fg=#ff0000 bg=#ffff60 deco=NONE cterm=NONE
hi TabLine fg=#000000 bg=#dadada deco=underline cterm=underline
...
hi ToolbarButton fg=NONE bg=#a8a8a8 deco=bold cterm=bold
hi NonText fg=#add8e6 bg=#ffffff deco=NONE cterm=NONE
hi SpecialKey fg=#add8e6 bg=NONE deco=NONE cterm=NONE
hi Visual fg=#000000 bg=#a8a8a8 deco=NONE cterm=NONE
hi VisualNOS fg=NONE bg=NONE deco=bold,underline ctermfg=NONE ctermbg=NONE cterm=underline
hi LineNr fg=#767676 bg=NONE deco=NONE cterm=NONE
hi FoldColumn fg=#767676 bg=NONE deco=NONE cterm=NONE
hi SignColumn fg=NONE bg=NONE deco=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi Underlined fg=#6a0dad bg=NONE deco=underline cterm=underline
hi Error fg=#ff0000 bg=#ffffff deco=reverse cterm=reverse
hi WarningMsg fg=#6a0dad bg=#ffffff deco=NONE cterm=NONE
hi MoreMsg fg=#006400 bg=#ffffff deco=NONE cterm=NONE
hi ModeMsg fg=#000000 bg=#ffffff deco=NONE cterm=NONE
hi Question fg=#a07070 bg=NONE deco=NONE cterm=NONE
hi Todo fg=#000000 bg=#ffff00 deco=NONE cterm=NONE
hi MatchParen fg=#ffffff bg=#ffafaf deco=NONE cterm=NONE
hi Search fg=#ffffff bg=#6a0dad deco=NONE cterm=NONE
hi IncSearch fg=#008b8b bg=#ffff00 deco=reverse cterm=reverse
hi WildMenu fg=#000000 bg=#ffff00 deco=bold cterm=bold
hi ColorColumn fg=#000000 bg=#ffafaf deco=NONE cterm=NONE
hi Cursor fg=#ffffff bg=#000000 deco=NONE cterm=NONE
hi lCursor fg=#000000 bg=#a07070 deco=NONE cterm=NONE
hi SpellBad fg=#ff0000 bg=NONE guisp=#ff0000 deco=undercurl cterm=underline
hi SpellCap fg=#2e8b57 bg=NONE guisp=#2e8b57 deco=undercurl cterm=underline
hi SpellLocal fg=#ff00ff bg=NONE guisp=#ff00ff deco=undercurl cterm=underline
hi SpellRare fg=#00008b bg=NONE guisp=#00008b deco=undercurl cterm=underline
hi Statement fg=#2e8b57 bg=NONE deco=bold cterm=bold
hi Type fg=#2e8b57 bg=NONE deco=bold cterm=bold
hi Comment fg=#a8a8a8 bg=NONE deco=bold cterm=NONE
hi StorageClass fg=#ff0000 bg=NONE deco=bold cterm=bold
hi Conceal fg=#add8e6 bg=NONE deco=NONE cterm=NONE
hi Identifier fg=#008b8b bg=NONE deco=NONE cterm=NONE
hi Constant fg=#a07070 bg=NONE deco=NONE cterm=NONE
hi Number fg=#a07070 bg=NONE deco=bold cterm=bold
hi Float fg=#a07070 bg=NONE deco=bold cterm=bold
hi PreProc fg=#6a0dad bg=NONE deco=NONE cterm=NONE
hi Special fg=#ff8c00 bg=NONE deco=NONE cterm=NONE
hi SpecialChar fg=#00008b bg=NONE deco=NONE cterm=NONE
...
hi Title fg=#006400 bg=NONE deco=bold cterm=bold
