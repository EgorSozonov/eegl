...
hi Normal fg=#ffffff bg=#262626 deco=NONE cterm=NONE
hi EndOfBuffer fg=#5f87d7 bg=NONE deco=NONE cterm=NONE
hi StatusLine fg=#000000 bg=#afaf87 deco=NONE cterm=NONE
hi StatusLineNC fg=#666666 bg=#afaf87 deco=NONE cterm=NONE
hi StatusLineTerm fg=#000000 bg=#afaf87 deco=NONE cterm=NONE
hi StatusLineTermNC fg=#666666 bg=#afaf87 deco=NONE cterm=NONE
hi VertSplit fg=#666666 bg=#afaf87 deco=NONE cterm=NONE
hi Pmenu fg=NONE bg=#4a4a4a deco=NONE cterm=NONE
hi PmenuSel fg=#262626 bg=#d7d787 deco=NONE cterm=NONE
hi PmenuSbar fg=NONE bg=#262626 deco=NONE cterm=NONE
hi PmenuThumb fg=NONE bg=#ffd700 deco=NONE cterm=NONE
hi PmenuMatch fg=#d7875f bg=#4a4a4a deco=NONE cterm=NONE
hi PmenuMatchSel fg=#d7875f bg=#d7d787 deco=NONE cterm=NONE
hi TabLineSel fg=#000000 bg=#afaf87 deco=NONE cterm=NONE
hi TabLine fg=#666666 bg=#333333 deco=NONE cterm=NONE
hi TabLineFill fg=#ff8787 bg=#333333 deco=NONE cterm=NONE
hi ToolbarLine fg=NONE bg=NONE deco=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi ToolbarButton fg=#262626 bg=#d7d787 deco=NONE cterm=NONE
hi NonText fg=#5f87d7 bg=NONE deco=NONE cterm=NONE
hi SpecialKey fg=#00875f bg=NONE deco=NONE cterm=NONE
hi QuickFixLine fg=#000000 bg=#5f87d7 deco=NONE cterm=NONE
hi Folded fg=#666666 bg=#000000 deco=NONE cterm=NONE
hi FoldColumn fg=#5f87d7 bg=#000000 deco=NONE cterm=NONE
hi CursorLine fg=NONE bg=#333333 deco=NONE cterm=NONE
hi CursorColumn fg=NONE bg=#333333 deco=NONE cterm=NONE
hi ColorColumn fg=NONE bg=#000000 deco=NONE cterm=NONE
hi CursorLineNr fg=NONE bg=#333333 deco=NONE cterm=NONE
hi Visual fg=#d7d787 bg=#5f8700 deco=NONE cterm=NONE
hi SignColumn fg=NONE bg=#262626 deco=NONE cterm=NONE
hi VisualNOS fg=#d7d787 bg=#5f8700 deco=NONE cterm=NONE
hi LineNr fg=#666666 bg=NONE deco=NONE cterm=NONE
hi Error fg=#ff0000 bg=#ffffff deco=reverse cterm=reverse
hi ErrorMsg fg=#ff0000 bg=#000000 deco=reverse cterm=reverse
hi ModeMsg fg=#262626 bg=#ffd700 deco=NONE cterm=NONE
hi WarningMsg fg=#ff8787 bg=NONE deco=NONE cterm=NONE
hi MoreMsg fg=#00875f bg=NONE deco=NONE cterm=NONE
hi Question fg=#ffd700 bg=NONE deco=NONE cterm=NONE
hi MatchParen fg=#000000 bg=#ffd700 deco=NONE cterm=NONE
hi Search fg=#000000 bg=#d7875f deco=NONE cterm=NONE
hi IncSearch fg=#000000 bg=#00ff00 deco=NONE cterm=NONE
hi Todo fg=#ff0000 bg=#ffff00 deco=NONE cterm=NONE
hi WildMenu fg=#262626 bg=#d7d787 deco=NONE cterm=NONE
hi Underlined fg=#5f87d7 bg=NONE deco=underline cterm=underline
hi Cursor fg=#333333 bg=#d7d787 deco=NONE cterm=NONE
hi lCursor fg=#262626 bg=#ffafaf deco=NONE cterm=NONE
hi SpellBad fg=#ff0000 bg=NONE guisp=#ff0000 deco=undercurl cterm=underline
hi SpellCap fg=#ffff00 bg=NONE guisp=#ffff00 deco=undercurl cterm=underline
hi SpellLocal fg=#ffafaf bg=NONE guisp=#ffafaf deco=undercurl cterm=underline
hi SpellRare fg=#ffd7af bg=NONE guisp=#ffd7af deco=undercurl cterm=underline
hi Comment fg=#666666 bg=NONE deco=NONE cterm=NONE
hi String fg=#87d7ff bg=NONE deco=NONE cterm=NONE
hi Identifier fg=#ff8787 bg=NONE deco=NONE cterm=NONE
hi Function fg=#ffd7af bg=NONE deco=NONE cterm=NONE
hi Special fg=#d7d787 bg=NONE deco=NONE cterm=NONE
hi Statement fg=#5f87d7 bg=NONE deco=bold cterm=bold
hi Constant fg=#ffafaf bg=NONE deco=NONE cterm=NONE
hi PreProc fg=#d7875f bg=NONE deco=NONE cterm=NONE
hi Type fg=#5f87d7 bg=NONE deco=bold cterm=bold
hi Operator fg=#d7875f bg=NONE deco=NONE cterm=NONE
hi Define fg=#ffd700 bg=NONE deco=bold cterm=bold
hi Structure fg=#00ff00 bg=NONE deco=NONE cterm=NONE
hi Directory fg=#00875f bg=NONE deco=bold cterm=bold
...
hi Title fg=#ffd700 bg=NONE deco=bold cterm=bold
