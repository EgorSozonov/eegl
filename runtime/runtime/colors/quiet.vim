...
if &background ==# 'dark'
  ...
  hi Normal fg=#dadada bg=#000000 deco=NONE cterm=NONE
  hi ColorColumn fg=NONE bg=#1c1c1c deco=NONE cterm=NONE
  hi Conceal fg=NONE bg=NONE deco=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi CurSearch fg=#ff5fff bg=#000000 deco=reverse cterm=reverse
  hi Cursor fg=NONE bg=NONE deco=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi CursorColumn fg=NONE bg=#303030 deco=NONE cterm=NONE
  hi CursorLine fg=NONE bg=#303030 deco=NONE cterm=NONE
  hi CursorLineNr fg=#dadada bg=#303030 deco=NONE cterm=NONE
  hi DiffAdd fg=#00af00 bg=#000000 deco=reverse cterm=reverse
  hi DiffChange fg=#87afd7 bg=#000000 deco=reverse cterm=reverse
  hi DiffDelete fg=#d75f5f bg=#000000 deco=reverse cterm=reverse
  hi DiffText fg=#d787d7 bg=#000000 deco=reverse cterm=reverse
  hi Directory fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi EndOfBuffer fg=#707070 bg=NONE deco=NONE cterm=NONE
  hi ErrorMsg fg=#dadada bg=#000000 deco=reverse cterm=reverse
  hi FoldColumn fg=#707070 bg=NONE deco=NONE cterm=NONE
  hi Folded fg=#707070 bg=#000000 deco=NONE cterm=NONE
  hi IncSearch fg=#ffaf00 bg=#000000 deco=reverse cterm=reverse
  hi LineNr fg=#585858 bg=NONE deco=NONE cterm=NONE
  hi MatchParen fg=#ff00af bg=NONE deco=bold cterm=bold
  hi ModeMsg fg=#dadada bg=NONE deco=bold cterm=bold
  hi MoreMsg fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi NonText fg=#707070 bg=NONE deco=NONE cterm=NONE
  hi Pmenu fg=#000000 bg=#a8a8a8 deco=NONE cterm=NONE
  hi PmenuMatch fg=#d7005f bg=#a8a8a8 deco=NONE cterm=NONE
  hi PmenuExtra fg=#000000 bg=#a8a8a8 deco=NONE cterm=NONE
  hi PmenuKind fg=#000000 bg=#a8a8a8 deco=bold cterm=bold
  hi PmenuSbar fg=#707070 bg=#585858 deco=NONE cterm=NONE
  hi PmenuSel fg=#000000 bg=#dadada deco=NONE cterm=NONE
  hi PmenuMatchSel fg=#d7005f bg=#dadada deco=bold cterm=bold
  hi PmenuExtraSel fg=#000000 bg=#dadada deco=NONE cterm=NONE
  hi PmenuKindSel fg=#000000 bg=#dadada deco=bold cterm=bold
  hi PmenuThumb fg=#dadada bg=#dadada deco=NONE cterm=NONE
  hi Question fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi QuickFixLine fg=#ff5fff bg=#000000 deco=reverse cterm=reverse
  hi Search fg=#00afff bg=#000000 deco=reverse cterm=reverse
  hi SignColumn fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi SpecialKey fg=#707070 bg=NONE deco=bold cterm=bold
  hi SpellBad fg=#d7005f bg=NONE guisp=#d7005f deco=undercurl cterm=underline
  hi SpellCap fg=#0087d7 bg=NONE guisp=#0087d7 deco=undercurl cterm=underline
  hi SpellLocal fg=#d787d7 bg=NONE guisp=#d787d7 deco=undercurl cterm=underline
  hi SpellRare fg=#00afaf bg=NONE guisp=#00afaf deco=undercurl cterm=underline
  hi StatusLine fg=#000000 bg=#dadada deco=bold cterm=bold
  hi StatusLineNC fg=#707070 bg=#000000 deco=reverse cterm=reverse
  hi TabLine fg=#707070 bg=#000000 deco=reverse cterm=reverse
  hi TabLineFill fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi TabLineSel fg=#000000 bg=#dadada deco=bold cterm=bold
  hi Title fg=NONE bg=NONE deco=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi VertSplit fg=#707070 bg=#000000 deco=NONE cterm=NONE
  hi Visual fg=#ffaf00 bg=#000000 deco=reverse cterm=reverse
  hi VisualNOS fg=NONE bg=#303030 deco=NONE cterm=NONE
  hi WarningMsg fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi WildMenu fg=#00afff bg=#000000 deco=bold cterm=bold
  hi Comment fg=#707070 bg=NONE deco=bold cterm=bold
  hi Constant fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi Error fg=#ff005f bg=#000000 deco=bold,reverse cterm=bold,reverse
  hi Identifier fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi Ignore fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi PreProc fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi Special fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi Statement fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi Todo fg=#00ffaf bg=NONE deco=bold,reverse cterm=bold,reverse
  hi Type fg=#dadada bg=NONE deco=NONE cterm=NONE
  hi Underlined fg=#dadada bg=NONE deco=underline cterm=underline
  hi CursorIM fg=#000000 bg=#afff00 deco=NONE cterm=NONE
  hi ToolbarLine fg=NONE bg=#000000 deco=NONE cterm=NONE
  hi ToolbarButton fg=#dadada bg=#000000 deco=bold cterm=bold
else
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi Normal fg=#000000 bg=#d7d7d7 deco=NONE cterm=NONE
  ...
  hi CursorLineNr fg=#000000 bg=#eeeeee deco=NONE cterm=NONE
  hi DiffAdd fg=#87d787 bg=#000000 deco=reverse cterm=reverse
  hi DiffChange fg=#afafd7 bg=#000000 deco=reverse cterm=reverse
  hi DiffDelete fg=#d78787 bg=#000000 deco=reverse cterm=reverse
  hi DiffText fg=#d787d7 bg=#000000 deco=reverse cterm=reverse
  hi Directory fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi EndOfBuffer fg=#626262 bg=NONE deco=NONE cterm=NONE
  hi ErrorMsg fg=#000000 bg=#d7d7d7 deco=reverse cterm=reverse
  hi FoldColumn fg=#626262 bg=NONE deco=NONE cterm=NONE
  hi Folded fg=#626262 bg=#d7d7d7 deco=NONE cterm=NONE
  hi IncSearch fg=#ffaf00 bg=#000000 deco=reverse cterm=reverse
  hi LineNr fg=#a8a8a8 bg=NONE deco=NONE cterm=NONE
  hi MatchParen fg=#ff00af bg=#d7d7d7 deco=bold cterm=bold
  hi ModeMsg fg=#000000 bg=NONE deco=bold cterm=bold
  hi MoreMsg fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi NonText fg=#626262 bg=NONE deco=NONE cterm=NONE
  hi Pmenu fg=#000000 bg=#a8a8a8 deco=NONE cterm=NONE
  hi PmenuMatch fg=#d70000 bg=#a8a8a8 deco=NONE cterm=NONE
  hi PmenuExtra fg=#000000 bg=#a8a8a8 deco=NONE cterm=NONE
  hi PmenuKind fg=#000000 bg=#a8a8a8 deco=bold cterm=bold
  hi PmenuSbar fg=#000000 bg=#e4e4e4 deco=NONE cterm=NONE
  hi PmenuSel fg=#d7d7d7 bg=#000000 deco=NONE cterm=NONE
  hi PmenuMatchSel fg=#d70000 bg=#000000 deco=bold cterm=bold
  hi PmenuExtraSel fg=#d7d7d7 bg=#000000 deco=NONE cterm=NONE
  hi PmenuKindSel fg=#d7d7d7 bg=#000000 deco=bold cterm=bold
  hi PmenuThumb fg=#000000 bg=#000000 deco=NONE cterm=NONE
  hi Question fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi QuickFixLine fg=#ff5fff bg=#000000 deco=reverse cterm=reverse
  hi Search fg=#00afff bg=#000000 deco=reverse cterm=reverse
  hi SignColumn fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi SpecialKey fg=#626262 bg=NONE deco=bold cterm=bold
  hi SpellBad fg=#af0000 bg=#d7d7d7 guisp=#af0000 deco=undercurl cterm=underline
  hi SpellCap fg=#005faf bg=#d7d7d7 guisp=#005faf deco=undercurl cterm=underline
  hi SpellLocal fg=#870087 bg=#d7d7d7 guisp=#870087 deco=undercurl cterm=underline
  hi SpellRare fg=#008787 bg=#d7d7d7 guisp=#008787 deco=undercurl cterm=underline
  hi StatusLine fg=#eeeeee bg=#000000 deco=bold cterm=bold
  hi StatusLineNC fg=#000000 bg=#a8a8a8 deco=NONE cterm=NONE
  hi TabLine fg=#000000 bg=#a8a8a8 deco=NONE cterm=NONE
  hi TabLineFill fg=#000000 bg=#d7d7d7 deco=NONE cterm=NONE
  hi TabLineSel fg=#eeeeee bg=#000000 deco=bold cterm=bold
  hi Title fg=NONE bg=NONE deco=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi VertSplit fg=#626262 bg=#d7d7d7 deco=NONE cterm=NONE
  hi Visual fg=#ffaf00 bg=#000000 deco=reverse cterm=reverse
  hi VisualNOS fg=NONE bg=#eeeeee deco=NONE cterm=NONE
  hi WarningMsg fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi WildMenu fg=#000000 bg=#eeeeee deco=bold cterm=bold
  hi Comment fg=#000000 bg=NONE deco=bold cterm=bold
  hi Constant fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi Error fg=#ff005f bg=#000000 deco=bold,reverse cterm=bold,reverse
  hi Identifier fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi Ignore fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi PreProc fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi Special fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi Statement fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi Todo fg=#00ffaf bg=#000000 deco=bold,reverse cterm=bold,reverse
  hi Type fg=#000000 bg=NONE deco=NONE cterm=NONE
  hi Underlined fg=#000000 bg=NONE deco=underline cterm=underline
  hi CursorIM fg=#000000 bg=#afff00 deco=NONE cterm=NONE
  hi ToolbarLine fg=NONE bg=#d7d7d7 deco=NONE cterm=NONE
  hi ToolbarButton fg=#000000 bg=#d7d7d7 deco=bold cterm=bold
endif
