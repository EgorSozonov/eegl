...
hi EndOfBuffer fg=#444444 bg=#000000 deco=NONE cterm=NONE
hi StatusLine fg=#000000 bg=#dadada deco=bold cterm=bold
hi StatusLineNC fg=#000000 bg=#6c6c6c deco=NONE cterm=NONE
hi StatusLineTerm fg=#000000 bg=#00ff00 deco=bold cterm=bold
hi StatusLineTermNC fg=#000000 bg=#5fd75f deco=NONE cterm=NONE
hi VertSplit fg=#000000 bg=#6c6c6c deco=NONE cterm=NONE
hi Pmenu fg=#dadada bg=#444444 deco=NONE cterm=NONE
hi PmenuSel fg=#000000 bg=#ffff00 deco=NONE cterm=NONE
hi PmenuSbar fg=NONE bg=#000000 deco=NONE cterm=NONE
hi PmenuThumb fg=NONE bg=#6c6c6c deco=NONE cterm=NONE
hi PmenuMatch fg=#ff00ff bg=#444444 deco=NONE cterm=NONE
hi PmenuMatchSel fg=#ff00ff bg=#ffff00 deco=NONE cterm=NONE
hi TabLine fg=#dadada bg=#444444 deco=NONE cterm=NONE
hi TabLineFill fg=NONE bg=#6c6c6c deco=NONE cterm=NONE
hi TabLineSel fg=#ffffff bg=#000000 deco=bold cterm=bold
hi ToolbarButton fg=#dadada bg=#6c6c6c deco=bold cterm=bold
hi ToolbarLine fg=NONE bg=#303030 deco=NONE cterm=NONE
hi NonText fg=#00afaf bg=NONE deco=NONE cterm=NONE
hi SpecialKey fg=#00afaf bg=NONE deco=NONE cterm=NONE
hi Folded fg=#00afaf bg=#303030 deco=NONE cterm=NONE
hi Visual fg=#dadada bg=#6c6c6c deco=NONE cterm=NONE
hi CursorLine fg=NONE bg=#6c6c6c deco=NONE cterm=NONE
hi CursorColumn fg=NONE bg=#6c6c6c deco=NONE cterm=NONE
hi CursorLineNr fg=#ffff00 bg=NONE deco=bold cterm=bold
hi ColorColumn fg=NONE bg=#444444 deco=NONE cterm=NONE
hi QuickFixLine fg=#000000 bg=#ff00ff deco=NONE cterm=NONE
hi VisualNOS fg=#dadada bg=#6c6c6c deco=NONE cterm=NONE
hi LineNr fg=#ffff00 bg=NONE deco=NONE cterm=NONE
hi FoldColumn fg=#00afaf bg=NONE deco=NONE cterm=NONE
hi SignColumn fg=#00afaf bg=NONE deco=NONE cterm=NONE
hi Underlined fg=#87afff bg=NONE deco=underline cterm=underline
hi Error fg=#ffffff bg=#ff0000 deco=NONE cterm=NONE
hi ErrorMsg fg=#ffffff bg=#ff0000 deco=NONE cterm=NONE
hi ModeMsg fg=#ffffff bg=NONE deco=bold cterm=bold
hi WarningMsg fg=#ff0000 bg=NONE deco=bold cterm=bold
hi MoreMsg fg=#5fd75f bg=NONE deco=bold cterm=bold
hi Question fg=#00ff00 bg=NONE deco=bold cterm=bold
hi Todo fg=#005fff bg=#ffff00 deco=NONE cterm=NONE
hi MatchParen fg=#303030 bg=#afaf00 deco=NONE cterm=NONE
...
hi lCursor fg=#000000 bg=#ff0000 deco=NONE cterm=NONE
hi SpellBad fg=#ff0000 bg=NONE guisp=#ff0000 deco=undercurl cterm=underline
hi SpellCap fg=#005fff bg=NONE guisp=#005fff deco=undercurl cterm=underline
hi SpellLocal fg=#ff00ff bg=NONE guisp=#ff00ff deco=undercurl cterm=underline
hi SpellRare fg=#00ff00 bg=NONE guisp=#00ff00 deco=undercurl cterm=underline
hi Comment fg=#00afaf bg=NONE deco=NONE cterm=NONE
hi Identifier fg=#ff00ff bg=NONE deco=NONE cterm=NONE
hi Function fg=#00ff00 bg=NONE deco=NONE cterm=NONE
hi Statement fg=#ffffff bg=NONE deco=bold cterm=bold
hi Constant fg=#00ffff bg=NONE deco=NONE cterm=NONE
hi PreProc fg=#ffff00 bg=NONE deco=NONE cterm=NONE
hi Type fg=#00ff00 bg=NONE deco=bold cterm=bold
hi Special fg=#ff0000 bg=NONE deco=NONE cterm=NONE
hi Delimiter fg=#ffff00 bg=NONE deco=NONE cterm=NONE
hi Directory fg=#00ffff bg=NONE deco=NONE cterm=NONE
hi Conceal fg=#6c6c6c bg=NONE deco=NONE cterm=NONE
